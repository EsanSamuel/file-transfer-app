...
const AddCard = ({ handleAddCard }) => {
    ...
    return (
        <div className='fixed bg-transparent w-full'>
            ...
            <div className='px-10 sm:mt-0 mt-[120px] bg-transparent fixed sm:ml-[75%] bottom-0  flex items-center justify-center ml-[28%]'>
                <Button
                    title=' + Add room'
                    styles='mb-28 z-10 px-7 py-4 rounded-[100px]  bg-[#1dc071] text-[20px]  float-right '
            ...
            <div className='sm:px-[200px] p-10 bg-transparent w-full flex justify-center items-center'>
                {room && (
                    <div className='p-10 bg-[#000026]  glass  text-center mt-[-20%] w-full sm:ml-[-20%] ml-[-25%]'>
